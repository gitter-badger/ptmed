...
{	
	...
	{	
 		...
 		if($this->request->method('POST'))
		{
			...
			$this->settings->accessories_category = $this->request->post('accessories_category_id');	
		...
		$accessories_category = $this->categories->get_category((int)$this->settings->accessories_category);
		$this->design->assign('accessories_category', $accessories_category);
