	...
	<input type="hidden" name="session_id" value="{$smarty.session.id}">
		...
		<div class="{if !$product->visible}invisible{/if} {if $product->featured}featured{/if} row">
			...
			<div class="icons cell">
				...
				<a class="featured"  title="Оборудование"           href="#"></a>
		...
		<div id="action">
			...
			<select name="action">
				...
				<option value="set_featured">Сделать вспомогательным</option>
				<option value="set_dop">Сделать доп. опцией</option>
				<option value="unset_featured">Отменить вспомогательное</option>
				<option value="unset_dop">Отменить доп. опцию</option>
...
<div id="right_menu">
	...
	<ul>
		...
		<li {if $filter=='featured'}class="selected"{/if}><a href="{url keyword=null brand_id=null category_id=null page=null filter='featured'}">Вспомогательное оборудование</a></li>
		<li {if $filter=='dop'}class="selected"{/if}><a href="{url keyword=null brand_id=null category_id=null page=null filter='dop'}">Доп. опции</a></li>
