...
<head>
	...
	<link rel="stylesheet" href="design/{$settings->theme|escape}/css/style.css" type="text/css" media="screen"/>
...
<header>
    ...
    <div id="contact">
        <i class="fa fa-phone"></i><span>+7 (812) 321 67 80</span>
    </div>
    <div class="clear"></div>        
    </div>
</header>
...
<nav>
            ...
            <li>
                ...
                {foreach $c->subcategories as $sc}
                    <li>
                        ...
                        <a {if $sc->id == $cs->id}class="selected"{/if} href="catalog/{$sc->url}">{$sc->name|escape}</a>
                    </li>
                {/foreach}
                </ul>
            </li>
    ...
    <ul>
        ...
        <li><a href="#callback" data-toggle="modal">Обратный звонок</a></li>
